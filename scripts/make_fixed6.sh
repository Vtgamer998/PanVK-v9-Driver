...
# ============================================================================
# make_fixed6.sh — Gera Winlator_11.1_mali_panvk_fixed6.apk
# Usando Winlator_11.1_mali_panvk_fixed3.apk como base (solicitação do usuário).
# ============================================================================
set -uo pipefail

DL=~/storage/downloads
WORK=~/panvk-work
TMP=/data/data/com.termux/files/usr/tmp/opencode/fixed6build
SRC="$DL/Winlator_11.1_mali_panvk_fixed3.apk"
OUT="$DL/Winlator_11.1_mali_panvk_fixed6.apk"
...
echo "== [2/6] Extraindo APK base ($SRC) =="
...
echo ""
echo "============================================================"
echo " SUCESSO! APK GERADO USANDO FIXED3:"
echo " $OUT"
echo "============================================================"
